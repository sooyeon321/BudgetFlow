...
- `budgetflow-web/src/lib/api/*` → API Gateway/Lambda 호출로 교체
- `budgetflow-web/src/lib/auth/*` → Cognito/Amplify Auth 연동으로 교체
...
- 도메인 타입: `budgetflow-web/src/lib/domain.ts`
- Mock API 구현: `budgetflow-web/src/lib/api/budgetflow-api.ts`
- Mock 데이터: `budgetflow-web/src/lib/api/mock-data.ts`
- Query hooks: `budgetflow-web/src/lib/hooks/use-budgetflow.ts`
- Project schema: `budgetflow-web/src/lib/forms/project.ts`
- Expense review schema: `budgetflow-web/src/lib/forms/expense-review.ts`
- Budget category schema: `budgetflow-web/src/lib/forms/budget-category.ts`
- Template schema: `budgetflow-web/src/lib/forms/template.ts`
- Auth placeholder: `budgetflow-web/src/lib/auth/auth-api.ts`
